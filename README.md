...
<!--
**marlonxromero/marlonxromero** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.

Here are some ideas to get you started:

- 🔭 I’m currently working on my final project for triple ten bootcamp to get my final certification in business analytics.
- 🌱 I’m currently learning more towards data analytics since it involves using more data tools such as SQl which ius my personal favoreit programming language. 
- 👯 I’m looking to collaborate on more data driven projects using Advanced SQL and Python as I would like to move in the direction of data engineering. 
- 🤔 I’m looking for help with coding projects. 
- 💬 Ask me about anything data related. I love helping others when they feel stuck with data projects. 
- 📫 How to reach me: Email: marlon22098@gmail.com
- ⚡ Fun fact: I am also an artist. I create content online via social media and I enjoy making short films as well as independent music. 
--> Linked below is my READme that showcases my latest tableau project. 
[README.md](https://github.com/user-attachments/files/23835839/README.md)
